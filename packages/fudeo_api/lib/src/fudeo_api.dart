...
import 'package:fudeo_api/src/models/notion_page_request.dart';
import 'package:http/http.dart';

class FudeoAPI {
  Future<NotionDatabaseQueryResponse<NotionJobOfferPage>> getJobOffers({
    String? cursor,
  }) async {
    final pageRequest = NotionPageRequest(
      cursor: cursor,
      pageSize: 100,
    );
    final response = await post(
      ...
      body: jsonEncode(pageRequest.toJson()),
    );
